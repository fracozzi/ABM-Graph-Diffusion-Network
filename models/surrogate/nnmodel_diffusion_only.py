    ...
    def train(self, ramifications, n_epochs=10):
        ...
        for epoch in tqdm(range(n_epochs), desc="Training"):
            ...
            for example in examples:
                ...
                state_t1 = torch.tensor(state_t1[:,self.static_feature_dim:]).to(torch.float32).to(device)
                ...
                prev_state_condition = torch.tensor(state_t0[:,self.static_feature_dim:]).to(torch.float32).to(device)
